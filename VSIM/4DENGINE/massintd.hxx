...
class mass_interface_diffusion : public process {

public:
	mass_interface_diffusion ();
	mass_interface_diffusion ( const mass_interface_diffusion& m_i_d );
	~mass_interface_diffusion () {}

	void 	ProbCalc();

	friend TextInputStream& operator >> ( TextInputStream& rTIS, mass_interface_diffusion& rObject );
