...
//---------------------------------------------------------------------------
//
//      Declaration of methods for INITIALIZE_THREE_D_SYSTEM
...
void initialize_three_d_system :: SetUpSimulation()
...
//
//---------------------------------------------------------------------------
void initialize_three_d_system :: ReadInData()
...

	{
	  ...
	  if ( Simulator->GetStatusCode() != SIM_RUNNING )
	  {
		...
		case START_SIM_INIT:
			...
			infile >> *( ( three_d_system* )Simulator );
			break;
