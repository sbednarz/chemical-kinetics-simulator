...
//--------------------------------------------------------------------------
//
//      Methods for class RATE_CONSTANT_UPDATE
...
void rate_constant_update :: UpdateState ()
...
{            //begin
	...
	case REACTION_COMPARTMENT:
		Simulator->UpdateKAfterReaction (event.ProcessAreaNo);
		break;

	default: // MASS_TRANSFER
		Simulator->UpdateKAfterTransfer (event.ProcessAreaNo);
		break;
	} //end switch
